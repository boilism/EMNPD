function format_Protein_NP_Active(d) {
...
$(document).ready(function () {
    ...
    $('#Protein_NP_Active').on('click', 'tbody td.dt-control', function () {
        ...
        if (row.child.isShown()) {
            ...
            // Open this row
            row.child(format_Protein_NP_Active(row.data())).show();
        }
    });

    $('#Protein_NP_Active').on('requestChild.dt', function (e, row) {
        row.child(format_Protein_NP_Active(row.data())).show();
    });
    ...
    var table = $('#Protein_NP_Active').DataTable({
