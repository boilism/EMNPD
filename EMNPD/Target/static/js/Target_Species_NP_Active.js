function format_Target_Species_NP_Active(d) {
...
$(document).ready(function () {
    ...
    $('#Target_Species_NP_Active').on('click', 'tbody td.dt-control', function () {
        ...
        if (row.child.isShown()) {
            ...
            // Open this row
            row.child(format_Target_Species_NP_Active(row.data())).show();
        }
    });

    $('#Target_Species_NP_Active').on('requestChild.dt', function (e, row) {
        row.child(format_Target_Species_NP_Active(row.data())).show();
    });
    ...
    var table = $('#Target_Species_NP_Active').DataTable({
