// @observablehq/runtime v5.5.2 Copyright 2023 Observable, Inc.
function e(e, t, n) {
    n = n || {};
...
function h(e) {
    try {
        ...
        const n = t.find((e => !e.modifier)), r = "Map" === n.name && t.find((e => e.modifier && e.prefix)),
            o = t.some((e => e.arrayish)), a = t.some((e => e.setish));
...
const {getPrototypeOf: b, getOwnPropertyDescriptors: w} = Object, y = b({});
...
class Inspector {
    ...
    fulfilled(t, n) {
        ...
        }(t) || t.parentNode && t.parentNode !== r) && (t = ae(t, !1, r.firstChild && r.firstChild.classList && r.firstChild.classList.contains("observablehq--expanded"), n)).classList.add("observablehq--inspect"), r.classList.remove("observablehq--running", "observablehq--error"), r.firstChild !== t) if (r.firstChild) {
...
function pe(e) {
    var t, n = e.getUTCHours(), r = e.getUTCMinutes(), o = e.getUTCSeconds(), a = e.getUTCMilliseconds();
...
function me(e) {
    ...
    function r(e, t) {
        var r, o = [], a = e.length, i = 0, s = 0, c = a <= 0, l = !1;
    ...
    return {
        parse: function (e, t) {
            ...
            return e.map(a).join("\n")
        }, formatRow: a, formatValue: i
    }
}

var he = me(","), be = he.parse, we = he.parseRows, ye = me("\t"), ve = ye.parse, _e = ye.parseRows;
...
const Ne = Ce("d3", "7.8.4", "dist/d3.min.js"), xe = Ce("@observablehq/inputs", "0.10.4", "dist/inputs.min.js"),
...
function nt(e = "https://cdn.jsdelivr.net/npm/", t = ["unpkg", "jsdelivr", "browser", "main"]) {
    ...
    return async function (r, o) {
        ...
        const i = await n(a);
        return `${e}${i.name}@${i.version}/${a.path || function (e) {
            for (const n of t) {
                let t = e[n];
...
class DuckDBClient {
    ...
    async queryStream(e, t) {
        ...
        return {
            schema: (a = o.value, a.schema.fields.map(gt)), async* readRows() {
                try {
    ...
    static async of(e = {}, t = {}) {
        ...
        return void 0 === t.query?.castTimestampToDate && (t = {
            ...
            if (t instanceof FileAttachment) await Nt(n, e, t); else if (_t(t)) await xt(n, e, t); else if (Array.isArray(t)) await Tt(n, e, t); else if (vt(t)) await async function (e, t, n) {
...
const It = Object.assign((async (e, t, n, r) => {
    ...
    if (jt(e)) return function (e, t) {
        const n = e;
        let {schema: r, columns: o} = e, a = !1;
        $t(r) || (r = dn(e, St(o) ? o : void 0), a = !0);
        ...
        if (t.types) {
            ...
            e = e.map((e => un(e, i, r)))
        } else a && (e = e.map((e => un(e, i, r))));
        for (const {type: n, operands: r} of t.filter) {
            const [{value: t}] = r, o = r.slice(1).map((({value: e}) => e));
            switch (n) {
                case"v": {
                    const [n] = o, r = sn(n);
                    e = e.filter((e => r(e[t])));
        ...
        if (t.names) {
            ...
            }))), o && (o = o.map((e => n.get(e)?.name ?? e))), e = e.map((e => Object.fromEntries(Object.keys(e).map((t => [n.get(t)?.name ?? t, e[t]])))))
        }
...
async function Ft(e, t, n) {
    ...
    if ("function" == typeof e.queryTag) {
        const r = new AbortController, o = {signal: r.signal};
...
const Jt = e => "number" == typeof e && !Number.isNaN(e), Kt = e => Number.isInteger(e) && !Number.isNaN(e),
    ...
    on = e => "object" == typeof e && null !== e, an = e => null != e;
...
function un(e, t, n) {
    const r = {};
    for (const o of n) {
        const n = t.get(o.name), a = e[o.name];
...
function dn(e, t = function (e) {
    ...
    for (const e of t) {
        ...
        for (const n of r) {
            ...
            if (null == r) continue;
            const o = typeof r;
            if ("string" !== o) ++t.defined, Array.isArray(r) ? ++t.array : r instanceof Date ? ++t.date : r instanceof ArrayBuffer ? ++t.buffer : "number" === o ? (++t.number, Number.isInteger(r) && ++t.integer) : o in t && ++t[o]; else {
...
class Workbook {
    ...
    sheet(e, t) {
        ...
        return function (e, {range: t, headers: n} = {}) {
            ...
            for (let t = o; t <= i; t++) {
                const n = l[t - o] = Object.create(null, {"#": {value: t + 1}}), i = e.getRow(t + 1);
                if (i.hasValues) for (let e = r; e <= a; e++) {
...
async function yn(e, t, {array: n = !1, typed: r = !1} = {}) {
    const o = await e.text(), a = "\t" === t ? n ? _e : ve : n ? we : be;
    if ("auto" === r && !n) {
        const e = a(o);
        return function (e, t) {
            const n = new Map(t.map((({name: e, type: t}) => [e, t])));
            return Object.assign(e.map((e => un(e, n, t))), {schema: t})
        }(e, dn(e, e.columns))
    }
    return a(o, r && ge)
}
...
var qn = Object.freeze({
    __proto__: null, disposable: jn, filter: function* (e, t) {
...
function On(e, t) {
    return function (n) {
        var r, o, a, i, s, c, l, u, f = n[0], d = [], p = null, m = -1;
...
function tr(e, t, n) {
    const r = this._module._scope, o = this._module._runtime;
    if (this._inputs.forEach(Kn, this), t.forEach(Jn, this), this._inputs = t, this._definition = n, this._value = void 0, n === Yn ? o._variables.delete(this) : o._variables.add(this), e !== this._name || r.get(e) !== this) {
        let t, a;
        if (this._name) if (this._outputs.size) r.delete(this._name), a = this._module._resolve(this._name), a._outputs = this._outputs, this._outputs = new Set, a._outputs.forEach((function (e) {
...
const nr = Symbol("variable"), rr = Symbol("invalidation"), or = Symbol("visibility");

function Module(e, t = []) {
    Object.defineProperties(this, {
        _runtime: {value: e},
        _scope: {value: new Map},
        _builtins: {value: new Map([["@variable", nr], ["invalidation", rr], ["visibility", or], ...t])},
...
Object.defineProperties(Module.prototype, {
    _resolve: {
        value: function (e) {
            ...
            if (!n) if (n = new Variable(2, this), this._builtins.has(e)) n.define(e, Hn(this._builtins.get(e))); else if (this._runtime._builtin._scope.has(e)) n.import(e, this._runtime._builtin); else {
                try {
        ...
        value: function (e, t) {
            ...
            for (const e of r) for (const [t, n] of e._scope) if (n._definition === Vn) {
                if (e === this && i._scope.has(t)) continue;
                const r = n._inputs[0]._module;
                r._source && a(r)
            }
            for (const [e, t] of o) for (const [r, o] of t._scope) {
                const t = e._scope.get(r);
                if (!t || 2 === t._type) if (o._definition === Vn) {
                    const t = o._inputs[0], a = t._module;
...
function pr(e, t) {
    let n, r, o = "function" == typeof IntersectionObserver && t._observer && t._observer._node, a = !o, i = Yn, s = Yn;
    return o && (r = new IntersectionObserver((([e]) => (a = e.isIntersecting) && (n = null, i()))), r.observe(o), e.then((() => (r.disconnect(), r = null, s())))), function (e) {
