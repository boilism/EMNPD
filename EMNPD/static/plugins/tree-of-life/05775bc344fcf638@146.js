...
function _update(chart,showLength){return(
...
function _linkVariable(linkStep){return(
...
function _linkExtensionVariable(linkStep,innerRadius){return(
...
async function _data(parseNewick,FileAttachment){return(
