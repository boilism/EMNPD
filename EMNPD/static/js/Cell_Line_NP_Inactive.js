function format_Cell_Line_NP_Inactive(d) {
...
$(document).ready(function () {
    ...
    $('#Cell_Line_NP_Inactive').on('click', 'tbody td.dt-control', function () {
        ...
        if (row.child.isShown()) {
            ...
            // Open this row
            row.child(format_Cell_Line_NP_Inactive(row.data())).show();
        }
    });

    $('#Cell_Line_NP_Inactive').on('requestChild.dt', function (e, row) {
        row.child(format_Cell_Line_NP_Inactive(row.data())).show();
    });
    ...
    var table = $('#Cell_Line_NP_Inactive').DataTable({
